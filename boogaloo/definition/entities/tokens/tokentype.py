...
class TokenType(EntityDefinition):
    ...
    Use a TokenCollectionDefinition for that: Usually, tokens of one type are distributed between various token collections, such
